...
Check andb3.
Check andb3 true.
Check andb3 true false.
Check andb3 true false false.
...
Theorem plus_1_neq_0_firsttry1 : forall n : nat,
  (1+n) =? 0 = false.
Proof.
  intros n.
  simpl.
...
Theorem plus_1_neq_0 : forall n : nat,
  (n + 1) =? 0 = false.
Proof.
  intros n. destruct n as [|n'] eqn: H.
  - reflexivity.
  - reflexivity.   Qed.
...
Theorem negb_involutive : forall b : bool,
  negb (negb b) = b.
Proof.
  intros b. Check negb. destruct b eqn:E.
  - reflexivity.
  - reflexivity.  Qed.
...
- destruct c.
+ reflexivity.
+ intros H1. simpl in H1. rewrite H1. reflexivity.
- destruct c.
+ reflexivity.
+ intros H2. simpl in H2. rewrite H2. reflexivity.
